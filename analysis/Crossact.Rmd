...
Analysis walkthrough for the paper "Sampling to learn words: 
Adults and children sample words that reduce referential ambiguity
" (Author names removed, 2019).
...
Note that we currently missing some demographic information (ethnicity & language) for 6 of the 56 participants, due to experimenter error.
